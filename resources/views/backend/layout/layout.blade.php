...
<!-- Mirrored from themesbrand.com/velzon/html/master/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 29 Feb 2024 11:19:46 GMT -->

<head>

    <meta charset="utf-8" />
    <title>Selim Yıldırım</title>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme01">
                                    <img src="../../{{ asset('backend') }}/assets/images/demo/default.png"
                                        alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme02">
                                    <img src="../../{{ asset('backend') }}/assets/images/demo/saas.png"
                                        alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme03">
                                    <img src="../../{{ asset('backend') }}/assets/images/demo/corporate.png"
                                        alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme04">
                                    <img src="../../{{ asset('backend') }}/assets/images/demo/galaxy.png"
                                        alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme05">
                                    <img src="../../{{ asset('backend') }}/assets/images/demo/material.png"
                                        alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme06">
                                    <img src="../../{{ asset('backend') }}/assets/images/demo/creative.png"
                                        alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme07">
                                    <img src="../../{{ asset('backend') }}/assets/images/demo/minimal.png"
                                        alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme08">
                                    <img src="../../{{ asset('backend') }}/assets/images/demo/modern.png"
                                        alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme09">
                                    <img src="../../{{ asset('backend') }}/assets/images/demo/interactive.png"
                                        alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme10">
                                    <img src="../../{{ asset('backend') }}/assets/images/demo/classic.png"
                                        alt="" class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme11">
                                    <img src="../../{{ asset('backend') }}/assets/images/demo/vintage.png"
                                        alt="" class="img-fluid">
                                </label>
                            </div>
...
<!-- Mirrored from themesbrand.com/velzon/html/master/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 29 Feb 2024 11:20:52 GMT -->
