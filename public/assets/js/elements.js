...
const plus = document.querySelector(".quanlity-plus");
getEventListeners(plus); // Chrome Developer Tools'da çalışır
document.addEventListener("DOMContentLoaded", function () {
    document.querySelectorAll(".cart-form").forEach(form => {
        const plus = form.querySelector(".quanlity-plus");
        const minus = form.querySelector(".quanlity-minus");
        const input = form.querySelector(".quantity-input");

        plus.addEventListener("click", function (e) {
            e.preventDefault(); // link davranışını durdur
